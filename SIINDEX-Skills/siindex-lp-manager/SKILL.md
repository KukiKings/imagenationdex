...
2. **Raydium requires the INDX mint address** — after token mint, save the mint address and use it here. Raydium won't recognise "INDX" by name — it needs the exact mint address (`9p9VMkgTEVdAeohk1zEuepvwBYUkzjnovMwwazyxsSEZ`), which is a plain SPL Token (original Token Program), not Token-2022. [SUPERSEDED 2026-07-27] This line originally said "Token-2022 mint address" — reversed after mainnet verification 2026-07-22 confirmed INDX is the original Token Program.
3. [SUPERSEDED 2026-07-27] "**Token-2022 transfer fees on Raydium** — Raydium AMM v4 may have partial support for Token-2022 transfer fee extension. Verify Raydium's current Token-2022 compatibility before seeding. If incompatible, the Raydium CLMM (concentrated liquidity) pool may be needed instead." — not applicable; INDX is a plain SPL Token with no Token-2022 transfer fee extension. 98/2 Law enforcement runs through SolSplits / application layer, not an on-chain transfer hook.
