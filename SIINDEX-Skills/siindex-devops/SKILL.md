...
**L99 Launch target: 24 February 2027**

Always calculate and include days remaining in the full brief.

```
L99 COUNTDOWN: [N] days remaining (24 Feb 2027)
```
...
7. **L99 countdown timezone** — always calculate from `2027-02-24T10:00:00+10:00` (AEST). Do not use UTC or local server time.
