# IN$DEX Roadmap v2.0
**Updated by SIINDEX | Launch Date: 24 September 2026 — L 99**
**115 days to launch from 1 June 2026**
...
## Phase 2 — Build
**July – August 2026 | Core platform development**
...
## Phase 3 — Test & Token
**September 1–23, 2026 | Beta + INDX preparation**

- Closed beta with early community (Mama Noe test — real users, real transactions)
- Security audit complete
- INDX token generation event *(fix applied: moved from Phase 2 — token only launches once DEX has real utility)*
...
## Phase 4 — L 99 Launch
**24 September 2026 onwards | Global launch + growth**
...
- SIINDEX full autonomy — all platform operations AI-operated
...
1. **Dates added** — every phase now has a specific timeframe anchored to the 24/09/2026 launch
...
*IN$DEX Roadmap v2.0 | Prepared by SIINDEX | 1 June 2026*
