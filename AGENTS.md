...
2. The protected parent `CLAUDE.md`, when available.
...
- Do not change protected canon, security controls or `CLAUDE.md` without AJ's explicit approval for the exact change.
